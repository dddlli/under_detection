...
class ResNet_Optim(BaseModule):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(ResNet_Optim, self).__init__(init_cfg)
    ...
    def _make_stem_layer(self, in_channels, stem_channels):
        ...
        self.non_local = NonLocalBlock(channel=64)
        self.blurpool = BlurPool(self.inplanes, filt_size=1, stride=2)
    ...
    def train(self, mode=True):
        ...
        freezed."""
        super(ResNet_Optim, self).train(mode)
        self._freeze_stages()
...
@BACKBONES.register_module()
class ResNetV1d_Optim(ResNet_Optim):
    ...
    def __init__(self, **kwargs):
        super(ResNetV1d_Optim, self).__init__(
