...
from ..utils import SELayer, make_divisible
...
class InvertedResidual(BaseModule):
    ...
    def __init__(self,
        ...
        if stride == 2:
            self.dwt = DWTPool2d(mid_channels)
...
class DWTEfficientNet(BaseModule):
    ...
    def __init__(self,
        ...
        super(DWTEfficientNet, self).__init__(init_cfg)
    ...
    def train(self, mode=True):
        super(DWTEfficientNet, self).train(mode)
        self._freeze_stages()
